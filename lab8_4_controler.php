<?php
    class Calculator {
        ...
        function addition() {
            ...
            echo "<h5 style='color: darkred'>$this->firstNumber + $this->secondNumber = $result</h5>";
        }
        ...
        function rootExtraction() {
            if($this->firstNumber >= 0 && $this->secondNumber >= 0) {
                echo "<h5 style='color: darkred'>sqrt($this->firstNumber) = " . round(sqrt($this->firstNumber), 3) . "</h5>";
                echo "<h5 style='color: darkred'>sqrt($this->secondNumber) = " . round(sqrt($this->secondNumber), 3) . "</h5>";
            } else {
        ...
        function test() {
            echo "<div style='border: solid blue; padding: 15px'>";
                $this->addition();
                $this->subtraction();
                $this->division();
                $this->modularDivison();
